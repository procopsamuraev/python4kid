...
while i < number_items:
    row=i+1 
    entry0, entry1, entry2, entry3, button, entry4 = Entry(), Entry(), Entry(), Entry(), Button(text='='), Entry()
    entry0.grid(column=0, row=row)
    entry1.grid(column=1, row=row)
    entry2.grid(column=2, row=row)
    entry3.grid(column=3, row=row)
    button.grid(column=4, row=row)
    entry4.grid(column=5, row=row)
    list_entries.extend([entry0, entry1, entry2, entry3, button, entry4])
    print(list_entries, row)
    i += 1
